...
plt.plot(x_values, y_values, mfc='red', ms=12, label='Analytical',linewidth=4)
plt.plot(x_ee_values, y_ee_values, mfc='blue', ms=12, label='Euler Upwind',linewidth=4)
plt.plot(x_i_values, y_i_values, mfc='orange', ms=12, label='Implicit',linewidth=4)
plt.plot(x_lax_values, y_lax_values, mfc='black', ms=12, label='Lax',linewidth=4)
plt.plot(x_rusanov_values, y_rusanov_values, mfc='red', ms=12, label='Rusanov',linewidth=4)
plt.xlabel('X Values')
plt.ylabel('Y Values')
plt.title('First Plot')
plt.axis([1.5,3.5,-0.5,1.5])
legend()
show()
